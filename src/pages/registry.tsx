      ...
      <List>
        ...
        <ListItem>
          <a target="_blank" href="https://www.etsy.com/people/xmlcsxf2/favorites/wedding-registry?ref=cl_share_button" rel="noopener noreferrer">
            <Image src="/etsy.svg" height={120} width={180} />
          </a>
        </ListItem>
      </List>
      <Typography variant="h2" sx={{mb: '0.5rem'}}>Gift address: <CopySelection copyText='Shaun and Charlotte, 33 Plough rise, RM14 1XR' /></Typography>
      <Typography>Shaun &amp; Charlotte</Typography>  
      <Typography>33 Plough rise</Typography>
      <Typography>RM14 1XR</Typography> <br/>

      <Typography variant="h2">Bank details</Typography> <br />
      <Typography>Jeremy Gaisie / Charlotte Brown </Typography>
      <Typography>Account number: 07990032 <CopySelection copyText="07930032" /></Typography>
